...
dash_app = dash.Dash(__name__,  
                external_stylesheets=[dbc.themes.BOOTSTRAP], server=flask_app,
                suppress_callback_exceptions=True, url_base_pathname='/dash/',
...
def my_dash_app():
    # dash_app.server = oncomine.init_oncomine(dash_app)
    # oncomine.init_callbacks(dash_app)
...
# dash_app.layout = html.Div(id='dash-container', children="hello world")
